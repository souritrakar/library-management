...
public class Returns extends JFrame
{
    ...
    public class Return{
        ...
        public Return(String user_name, String user_class, String user_id){
    ...
    Returns(){
        setTitle("Returns - Library Manager"); 
        ...
        JButton addU = new JButton("Return book");
        ...
        empty = new JLabel("No book returns to show.");
        empty.setBounds(265, 200,280,50);
        empty.setForeground(Color.BLACK);
        empty.setFont(new Font("Calibri", Font.BOLD, 20));
        
        String[] columnNames = {"Book", "User", "Date Returned" ,"User_ID"};
        File users_file = new File("C:\\Library\\returns.csv");
        
        try{
        
        if(users_file.exists()){
            empty.setVisible(false);
            CSVReader reader = new CSVReader(new FileReader("C:\\Library\\returns.csv"));
