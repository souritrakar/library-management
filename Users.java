...
public class Users extends JFrame
{
    ...
    public class User{
        ...
        public User(String user_name, String user_class){
    ...
    Users(){
        setTitle("Users - Library Manager"); 
        ...
        empty = new JLabel("No created users to show.");
        empty.setBounds(275, 180,250,50);
        empty.setForeground(Color.BLACK);
        empty.setFont(new Font("Calibri", Font.BOLD, 20));
        
        String[] columnNames = {"Name", "Class", "User_ID"};
        File users_file = new File("C:\\Library\\users.csv");
        
        try{
        
        if(users_file.exists()){
            empty.setVisible(false);
            CSVReader reader = new CSVReader(new FileReader("C:\\Library\\users.csv"));
